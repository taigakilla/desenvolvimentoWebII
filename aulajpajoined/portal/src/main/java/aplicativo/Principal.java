...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Professor professor1 = new Professor("Rafael", "XXX.XXX.XXX-XX", 1);
		Aluno aluno1 = new Aluno("Miguel", "XXX.XXX.XXX-XX", 1);
		
		Professor professor2 = new Professor("Gabriel", "XXX.XXX.XXX-XX", 2);
		Aluno aluno2 = new Aluno("Uriel", "XXX.XXX.XXX-XX", 2);
